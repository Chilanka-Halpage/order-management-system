...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OrderServiceRuntimeException.class)
    public ResponseEntity<ActionResponse<String>> handleProductRuntimeException(OrderServiceRuntimeException exception) {
